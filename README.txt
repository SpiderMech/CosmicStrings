...
3. Translating the current mesh: HOLD down right mouse key and DRAG
<!!!> This function requires further refinement, only works in the fourth quadrant of world axes
...
<!!!> There's no way to return to previous render, refresh the page to return to the mesh.
